# cinode-client — plan for v0.1

> **Archived.** This plan was carried out in full and released as
> [v0.1.0](https://github.com/knowit-solutions-cocreate/cinode-client/releases/tag/v0.1.0)
> on 2026-09-23. It is frozen: task numbers here are what the PR titles and
...
Moved to [`docs/roadmap.md`](../roadmap.md) when this plan was archived.
